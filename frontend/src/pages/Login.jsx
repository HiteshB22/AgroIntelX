      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 relative pt-28">
        ...
        >
          ...
          <p className="text-center text-sm text-gray-600 font-medium">
            ...
            <Link to="/signup" className="text-brand-600 hover:text-brand-800 transition-colors">
              Create an account
            </Link>
          </p>
        </motion.div>
      ...
      <div className="hidden lg:flex w-1/2 bg-brand-900 relative items-center justify-center p-12 overflow-hidden pt-32">
        ...
        >
          ...
          <h3 className="text-4xl md:text-5xl font-extrabold leading-tight">
            Unlock the intelligence hidden in your soil.
          </h3>
          <p className="text-brand-100/80 text-lg font-medium leading-relaxed">
            Join the network of modern farmers utilizing advanced AI to elevate their agricultural practices, decrease costs, and exponentially increase yield.
          </p>
          ...
          <div className="pt-8 flex items-center gap-4">
            ...
            <div className="text-sm font-medium text-brand-200">
              Joined by <span className="text-white font-bold">10,000+</span> modern farmers
            </div>
          </div>
        </motion.div>
      </div>
