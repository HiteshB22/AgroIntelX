...
const Footer = () => (
  <footer className="bg-white border-t border-gray-100 mt-auto py-16 text-sm relative overflow-hidden">
    {/* Subtle Background Glow */}
    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-brand-50/50 rounded-full blur-3xl -z-10 pointer-events-none"></div>

    <div className="max-w-7xl mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="md:col-span-1">
          <Link to="/" className="flex items-center space-x-2 group mb-4">
            <div className="w-8 h-8 bg-gradient-to-br from-brand-500 to-brand-700 rounded-lg flex items-center justify-center text-white text-sm shadow-md group-hover:shadow-brand-500/30 transition-shadow">
              🌱
            </div>
            <h3 className="font-extrabold text-xl tracking-tight text-gray-900 group-hover:text-brand-700 transition-colors">
              AgroIntelX
            </h3>
          </Link>
          <p className="text-gray-500 leading-relaxed max-w-xs">
            Empowering farmers with AI-driven agriculture insights for a sustainable and profitable future.
          </p>
        </div>
      ...
      <div className="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-gray-400 font-medium">
          &copy; {new Date().getFullYear()} AgroIntelX. All rights reserved.
        </p>
